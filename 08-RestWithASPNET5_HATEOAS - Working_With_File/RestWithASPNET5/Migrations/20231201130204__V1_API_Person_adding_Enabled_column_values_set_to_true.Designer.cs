...
namespace RestWithASPNET5.Migrations
{
    ...
    [Migration("20231201130204__V1_API_Person_adding_Enabled_column_values_set_to_true")]
    partial class _V1_API_Person_adding_Enabled_column_values_set_to_true
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestWithASPNET5.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RefreshToken = "",
                            RefreshTokenExpiryTime = new DateTime(2023, 12, 1, 10, 2, 4, 241, DateTimeKind.Local).AddTicks(6959),
                            Username = "evandro"
                        });
                });
