...
namespace RestWithASPNET5.Migrations
{
    ...
    [Migration("20231201125838__V1_API_Person_adding_disabled_column")]
    partial class _V1_API_Person_adding_disabled_column
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestWithASPNET5.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RefreshToken = "",
                            RefreshTokenExpiryTime = new DateTime(2023, 12, 1, 9, 58, 36, 447, DateTimeKind.Local).AddTicks(3521),
                            Username = "evandro"
                        });
                });
